...
class Collateral(models.Model):
    ...
    status = models.ForeignKey('catalog.Status', verbose_name="Идентификатор status",
                               on_delete=models.SET_NULL,
                               blank=True, null=True)
    departament = models.ForeignKey('catalog.Departament', verbose_name="Идентификатор departament",
                                    on_delete=models.SET_NULL,
                                    blank=True, null=True)
